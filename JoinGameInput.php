...
function CardIDOverride($cardID) {
  switch($cardID) {
    ...
    case "SHD_066": return "SOR_068";
    case "SHD_070": return "SOR_069";
    case "SHD_085": return "SOR_083";
    case "SHD_083": return "SOR_081";
    case "SHD_166": return "SOR_162";
    case "SHD_223": return "SOR_215";
    case "SHD_238": return "SOR_229";
    case "SHD_257": return "SOR_247";
    case "SHD_262": return "SOR_251";
