<?php
  ...
  include './zzImageConverterHS.php';
  ...
  while ($hasMoreData)
  {
    ...
    for ($i = 0; $i < count($response->data); ++$i)
    {
      ...
      if($imageUrl == null) continue; //skip if no image found
      CheckImage($card->cardUid, $imageUrl, $language,  isLandscape:$isLandscape, isBottomPosition:$isBottomPosition); //Leader side
