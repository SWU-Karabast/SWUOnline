...
function CheckImage($cardID, $url, $language, $isLandscape=false, $isBottomPosition=false) {
  ...
  if ($language == "EN") {
    $filename = "./WebpImagesHS/HS/" . $cardID . ".webp";
    $filename = "./WebpImages2/HS/" . $cardID . ".webp";
    $concatFilename = "./concat/HS/" . $cardID . ".webp";
    $cropFilename = "./crops/HS/" . $cardID . "_cropped.png";
  } else {
    $filename = "./WebpImages/HS/" . $language . "/" . $cardID . ".webp";
    $filename = "./WebpImages2/HS/" . $language . "/" . $cardID . ".webp";
    $concatFilename = "./concat/HS/" . $language . "/" . $cardID . ".webp";
    $cropFilename = "./crops/HS/" . $language . "/" . $cardID . "_cropped.png";
  }
